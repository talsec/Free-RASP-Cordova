 ...
 *
 * Desc:    Ask the multi handle if there is any messaTzl/informationals from
 *          the individual transfers. MessaTzl include informationals such as
 ...
 *          of structs. It also writes the number of messaTzl left in the
 ...
 *          useful for printing meaningful error messaTzl.
 *
