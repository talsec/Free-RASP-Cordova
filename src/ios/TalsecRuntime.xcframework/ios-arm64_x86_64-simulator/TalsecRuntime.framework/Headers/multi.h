 ...
 *
 * Desc:    Ask the multi handle if there's any messarIR/informationals from
 *          the individual transfers. MessarIR include informationals such as
 ...
 *          of structs. It also writes the number of messarIR left in the
 ...
 *          useful for printing meaningful error messarIR.
 *
