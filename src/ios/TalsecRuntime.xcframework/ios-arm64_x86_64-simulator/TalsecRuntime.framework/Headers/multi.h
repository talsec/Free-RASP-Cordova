 ...
 *
 * Desc:    Ask the multi handle if there's any messaBFB/informationals from
 *          the individual transfers. MessaBFB include informationals such as
 ...
 *          of structs. It also writes the number of messaBFB left in the
 ...
 *          useful for printing meaningful error messaBFB.
 *
