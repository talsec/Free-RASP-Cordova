 ...
 *
 * Desc:    Ask the multi handle if there's any messaQTQ/informationals from
 *          the individual transfers. MessaQTQ include informationals such as
 ...
 *          of structs. It also writes the number of messaQTQ left in the
 ...
 *          useful for printing meaningful error messaQTQ.
 *
