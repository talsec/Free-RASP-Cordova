 ...
 *
 * Desc:    Ask the multi handle if there's any messaGyz/informationals from
 *          the individual transfers. MessaGyz include informationals such as
 ...
 *          of structs. It also writes the number of messaGyz left in the
 ...
 *          useful for printing meaningful error messaGyz.
 *
