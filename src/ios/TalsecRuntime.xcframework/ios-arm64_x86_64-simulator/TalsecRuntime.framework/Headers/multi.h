 ...
 *
 * Desc:    Ask the multi handle if there's any messaJiR/informationals from
 *          the individual transfers. MessaJiR include informationals such as
 ...
 *          of structs. It also writes the number of messaJiR left in the
 ...
 *          useful for printing meaningful error messaJiR.
 *
