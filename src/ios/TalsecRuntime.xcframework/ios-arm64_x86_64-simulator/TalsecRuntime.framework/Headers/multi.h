 ...
 *
 * Desc:    Ask the multi handle if there's any messaAHr/informationals from
 *          the individual transfers. MessaAHr include informationals such as
 ...
 *          of structs. It also writes the number of messaAHr left in the
 ...
 *          useful for printing meaningful error messaAHr.
 *
