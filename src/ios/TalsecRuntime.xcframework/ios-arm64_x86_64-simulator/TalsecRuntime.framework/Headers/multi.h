 ...
 *
 * Desc:    Ask the multi handle if there's any messasWC/informationals from
 *          the individual transfers. MessasWC include informationals such as
 ...
 *          of structs. It also writes the number of messasWC left in the
 ...
 *          useful for printing meaningful error messasWC.
 *
