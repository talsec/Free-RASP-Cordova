 ...
 *
 * Desc:    Ask the multi handle if there is any messaYVU/informationals from
 *          the individual transfers. MessaYVU include informationals such as
 ...
 *          of structs. It also writes the number of messaYVU left in the
 ...
 *          useful for printing meaningful error messaYVU.
 *
