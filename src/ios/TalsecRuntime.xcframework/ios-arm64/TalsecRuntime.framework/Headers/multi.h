 ...
 *
 * Desc:    Ask the multi handle if there's any messacMr/informationals from
 *          the individual transfers. MessacMr include informationals such as
 ...
 *          of structs. It also writes the number of messacMr left in the
 ...
 *          useful for printing meaningful error messacMr.
 *
