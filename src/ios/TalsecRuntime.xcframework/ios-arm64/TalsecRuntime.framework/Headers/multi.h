 ...
 *
 * Desc:    Ask the multi handle if there's any messahFl/informationals from
 *          the individual transfers. MessahFl include informationals such as
 ...
 *          of structs. It also writes the number of messahFl left in the
 ...
 *          useful for printing meaningful error messahFl.
 *
