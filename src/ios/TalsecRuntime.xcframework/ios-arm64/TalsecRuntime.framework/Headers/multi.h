 ...
 *
 * Desc:    Ask the multi handle if there is any messaKbZ/informationals from
 *          the individual transfers. MessaKbZ include informationals such as
 ...
 *          of structs. It also writes the number of messaKbZ left in the
 ...
 *          useful for printing meaningful error messaKbZ.
 *
